...
import com.foxprox.network.proxy.core.api.chat.hover.content.Content;
...
public final class ChatComponentTransformer
{
    ...
    public BaseComponent[] legacyHoverTransform(FoxPlayer player, BaseComponent... components)
    {
     ...
     */
    public BaseComponent[] transform(FoxPlayer player, BaseComponent... components)
    {
     ...
     * @throws IllegalArgumentException if an entity selector pattern is present
     */
    public BaseComponent[] transform(FoxPlayer player, boolean transformHover, BaseComponent... components)
    {
     ...
     */
    private void transformScoreComponent(FoxPlayer player, ScoreComponent component)
    {
