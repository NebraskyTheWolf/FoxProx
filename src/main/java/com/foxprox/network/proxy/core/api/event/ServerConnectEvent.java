...
public class ServerConnectEvent extends Event implements Cancellable
{
    ...
    @Deprecated
    public ServerConnectEvent(FoxPlayer player, ServerInfo target)
    {
        this( player, target, Reason.UNKNOWN );
    }

    @Deprecated
    public ServerConnectEvent(FoxPlayer player, ServerInfo target, Reason reason)
    {
        this( player, target, reason, null );
    }

    public ServerConnectEvent(FoxPlayer player, ServerInfo target, Reason reason, ServerConnectRequest request)
    {
        this.player = player;
        this.target = target;
        this.reason = reason;
