...
import com.foxprox.network.proxy.core.api.scheduler.GroupedThreadFactory;
...
public class Plugin
{
    ...
    protected Plugin(FoxServer proxy, PluginDescription description)
    {
        ClassLoader classLoader = getClass().getClassLoader();
     ...
     * be a child of {@link FoxServer#getPluginsFolder()}.
     *
     ...
     */
    final void init(FoxServer proxy, PluginDescription description)
    {
        this.proxy = proxy;
