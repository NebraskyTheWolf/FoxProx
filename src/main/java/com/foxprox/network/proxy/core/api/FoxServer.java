...
public abstract class FoxServer
{
    ...
    @Getter
    private static FoxServer instance;
     ...
     */
    public static void setInstance(FoxServer instance)
    {
        Preconditions.checkNotNull( instance, "instance" );
        Preconditions.checkArgument( FoxServer.instance == null, "Instance already set" );
        FoxServer.instance = instance;
    }
     ...
     */
    public abstract Collection<FoxPlayer> getPlayers();
     ...
     */
    public abstract FoxPlayer getPlayer(String name);
     ...
     * @return their player instance
     */
    public abstract FoxPlayer getPlayer(UUID uuid);
     ...
     * match
     */
    public abstract Collection<FoxPlayer> matchPlayer(String match);
    ...
    public abstract EntityPermissions getPlayerPermissions(FoxPlayer player);
