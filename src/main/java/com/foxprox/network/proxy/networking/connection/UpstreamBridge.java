...
import com.foxprox.network.proxy.core.api.event.SettingsChangedEvent;
import com.foxprox.network.proxy.core.api.event.TabCompleteEvent;
...
import com.foxprox.network.util.AllowedCharacters;
...
public class UpstreamBridge extends PacketHandler
{
    ...
    public UpstreamBridge(FoxServer bungee, UserConnection con)
    {
        this.bungee = bungee;
        this.con = con;

        FoxProx.getInstance().addConnection( con );
        con.getTabListHandler().onConnect();
        con.unsafe().sendPacket( FoxProx.getInstance().registerChannels( con.getPendingConnection().getVersion() ) );
    }
    ...
    public void disconnected(ChannelWrapper channel) throws Exception
    {
        ...
        FoxProx.getInstance().removeConnection( con );
        ...
        if ( con.getServer() != null )
        {
            ...
            for ( FoxPlayer player : con.getServer().getInfo().getPlayers() )
            {
